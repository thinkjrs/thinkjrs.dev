...
<Image
  ...
  alt="A white, old-school alarm clock in the middle of a dual-toned pink (left) and blue (right) image to signify the closest thing @thinkjrs could quickly find that visually represented the program 'cron'."
  height={1322}
  width={1980}
/>
<div className="text-sm text-gray-600">
  Photo by{' '}
  <a target="_blank" noreferrer="true" href="https://unsplash.com/@icons8">
    Icons8 Team
  </a>{' '}
  on <a href="https://unsplash.com/s/photos/schedule">Unsplash</a>
</div>
