...
### P.S. Why not use a faster Fibonacci algorith?
...
Check out the [corresponding Github repo](https://github.com/thinkjrs/nextjs-wasm) that has this code in it. It's MIT, so feel free to use at-will and contribute, if that's how you roll.
